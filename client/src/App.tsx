  ...
  return (
    <React.Fragment>
      <div className="w-screen min-h-fit bg-[#F9F3DF] lg:flex flex-col justify-between">
        <Navbar />
        <BurgerNavbar />
        <div className="flex flex-col lg:flex-row items-center justify-between lg:items-start lg:justify-between pl-[10vw] w-full h-full pt-16 min-[350px]:pt-10 lg:pt-0">
          ...
          <div className="flex flex-col items-center w-screen lg:w-auto pt-16 lg:pt-0">
            <img
